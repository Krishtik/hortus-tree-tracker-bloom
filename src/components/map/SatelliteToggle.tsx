  ...
  return (
    <div className="absolute top-24 right-6 z-20">
      <Button
        ...
        variant="outline"
        size="sm"
        className={`h-12 px-4 backdrop-blur-xl shadow-xl border transition-all duration-300 hover:scale-105 rounded-2xl group ${
          isSatelliteView 
      ...
      >
        {isSatelliteView ? (
          <>
            ...
            <span className="font-medium text-sm">Street</span>
          </>
        ) : (
          <>
