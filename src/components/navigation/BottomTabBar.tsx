...
const BottomTabBar = ({ activeTab, onTabChange }: BottomTabBarProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 bg-white/95 dark:bg-gray-950/95 backdrop-blur-xl border-t border-gray-200/50 dark:border-gray-800/50 p-2">
