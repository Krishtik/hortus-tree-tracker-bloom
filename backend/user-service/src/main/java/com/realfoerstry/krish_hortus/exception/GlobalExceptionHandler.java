 ...
 * ---------------------
 * This file catches and handles errors for the whole user-service.
 *
 * What does this file do?
 * - When something goes wrong (like a missing user, bad input, or database error),
 *   this class catches the error and returns a clear, helpful message to the client.
 * - This makes the API easier to use and debug, and prevents ugly error pages.
 *
