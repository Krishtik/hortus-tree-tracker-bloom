...
public class PasswordGenerator {
     ...
     * PasswordGenerator
     * -----------------
     * This file provides a helper function to generate strong, random passwords.
     *
     * What does this utility do?
     * - Creates a password with uppercase, lowercase, digits, and special characters
     * - Makes sure the password is hard to guess
     *
     * This can be used if you want to auto-generate passwords for new users or password resets.
     */
