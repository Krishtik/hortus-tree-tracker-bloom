...
@CrossOrigin(origins = { "http://localhost:5173", "https://hortus.krishhortus.com" })
public class TreeController {
     ...
     * 
     * @param category Optional tree category filter (FARM, COMMUNITY, NURSERY,
     *                 etc.)
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Map<String, Object>> updateTree(@PathVariable String id,
